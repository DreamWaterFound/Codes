...
class MotionDetector_DiffBase:public MotionDetector_base
{public:
    /**
     * @brief Construct a new MotionDetector_DiffBase object
     * 
     */
    MotionDetector_DiffBase();

    /**
     * @brief Destroy the MotionDetector_DiffBase object
     * 
     */
    ~MotionDetector_DiffBase();
